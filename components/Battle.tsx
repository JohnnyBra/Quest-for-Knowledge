  ...
  return (
    <div className="flex flex-col h-[75vh] md:h-[600px] w-full max-w-2xl mx-auto border-4 border-[#2d2d2d] bg-[#1a1a1a] rounded-lg shadow-2xl overflow-hidden font-retro">
      ...
      <div className="relative h-[40%] md:h-1/2 w-full overflow-hidden">
        ...
        <div className="absolute bottom-2 left-4 md:left-12 z-10 animate-bounce-slow">
            <img src={enemy.sprite} alt="Enemy" className="w-20 h-20 md:w-32 md:h-32 object-contain drop-shadow-2xl transform scale-x-[-1]" style={{ imageRendering: 'pixelated' }} />
        </div>
        
        <div className="absolute bottom-2 right-4 md:right-12 z-10">
